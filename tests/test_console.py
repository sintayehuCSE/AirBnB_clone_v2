...
class TestConsole(unittest.TestCase):
    """Class for testing the console of Abnb Clone."""
    def test_obj_creation(self):
        """Check the creation of Console object."""
        obj = HBNBCommand()
        self.assertIsInstance(obj, HBNBCommand)
    
    def test_prompting(self):
        """Test the prompting string of the console."""
...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        hmsg = "Qiuts the command interpretor session."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd('help quit'))
            self.assertEqual(hmsg, output.getvalue().strip())
    
    def test_help_create(self):
        hmsg = ("Usage: create <class>\n        "
    ...
    def test_help_EOF(self):
        h = "Qiuts the command interpretor session."
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_invalid_class(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            correct = "*** Unknown syntax: MyModel.show()"
...
class TestHBNBCommand_all(unittest.TestCase):
    ...
    def test_all_invalid_class(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            correct = "*** Unknown syntax: MyModel.all()"
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_invalid_class(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            correct = "*** Unknown syntax: MyModel.update()"
...
class TestHBNBCommand_count(unittest.TestCase):
    ...
    def test_count_invalid_class(self):
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual("*** Unknown syntax: MyModel.count()", output.getvalue().strip())
